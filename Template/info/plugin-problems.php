...
<div class="page-margin pm-page-margin">
    ...
    <section class="plugin-problems-section">
        <h3 class="">
            ...
            <span><?= t('Check the overrides') ?></span>
        </h3>
        <div class="panel">
            <ul class="">
                <li class="">
    ...
    <section class="plugin-problems-section">
        <h3 class="">
            ...
            <span><?= t('Check the application setup') ?></span>
        </h3>
        <div class="panel">
            <ul class="">
                <li class="">
    ...
    <section class="plugin-problems-section">
        <h3 class="">
            ...
            <span><?= t('Check the database') ?></span>
        </h3>
        <div class="panel">
            <ul class="">
                <li class="">
    ...
    <section class="plugin-problems-section">
        <h3 class="">
            ...
            <span><?= t('If everything fails') ?></span>
        </h3>
        <div class="panel">
            <ul class="">
                <li class="">
