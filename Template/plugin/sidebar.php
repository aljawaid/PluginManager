<div class="sidebar">
    <ul class="plugin-menu">
        ...
        <li <?= $this->app->checkMenuSelection('KanboardPluginsUXController', 'show') ?>>
            ...
            <?= $this->url->link(t('Plugin Problems'), 'KanboardPluginsUXController', 'show', array('plugin' => 'KanboardPluginsUX')) ?>
        </li>
    </ul>
</div>
