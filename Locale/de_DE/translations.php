...
"Plugin Problems" => "Erweiterungsprobleme",
"Unable to open plugin archive" => "Erweiterungs-Archiv kann nicht geöffnet werden",
"Unable to extract plugin archive." => "Das Erweiterungs-Archiv kann nicht extrahiert werden.",
"Plugin installed successfully" => "Erweiterung erfolgreich installiert",
"Plugin archive file not found" => "Erweiterungs-Archivdatei nicht gefunden",
"Plugin Info" => "Informationen",
"Installed Plugins" => "Erweiterungen",
"Manual Plugins" => "Manuelle Installation",
"Plugin directory not found." => "Erweiterungs-Verzeichnis nicht gefunden.",
...
"Plugin Manager will highlight the last updated date based on the date specified by the plugin developer in the Plugins Directory." => "Plugin Manager hebt das Datum der letzten Aktualisierung hervor, das auf der vom Erweiterungs-Entwickler im Erweiterungs-Verzeichnis angegebenen Datum basiert.",
"Active" => "Aktiv",
...
"Plugin Structure" => "Erweiterungs-Struktur",
...
"Go to Plugin Information" => "Zu den Erweiterungs-Informationen gehen",
"Plugin Types" => "Erweiterungs-Typen",
...
"All plugins do the same basic job of extending the features of the application. Different functions require different ways of coding which is why all plugins fall into one of the types below." => "Alle Erweiterungen erfüllen die gleiche grundlegende Aufgabe, nämlich die Erweiterung der Funktionen der Anwendung. Unterschiedliche Funktionen erfordern unterschiedliche Arten der Codierung, weshalb alle Erweiterungen in eine der folgenden Kategorien fallen.",
"General Plugin" => "Allgemeine Erweiterung",
"A plugin of any type but with no automatic actions" => "Eine Erweiterung eines beliebigen Typs, aber ohne automatische Aktionen",
"Action Plugin" => "Action Plugin",
"A plugin for automatic actions only" => "Ein Plugin nur für automatisierte Aktionen",
"Theme Plugin" => "Theme Plugin",
"A plugin for theming and styling of the interface" => "Ein Plugin für das Theme und Styling der Benutzeroberfläche",
"Connector Plugin" => "Anbindungserweiterung",
"A plugin connecting to third party services - may contain automatic actions" => "Ein Plugin, das sich mit Diensten Dritter verbindet - kann automatische Aktionen enthalten",
...
"Readme" => "Readme",
"All plugins should have a readme file in the root of their plugin folder. This icons should show against all plugins." => "Alle Erweiterungen sollten eine Readme-Datei im Stammverzeichnis ihres Plugin-Ordners haben. Diese Symbole sollten bei allen Erweiterungen angezeigt werden.",
...
"folder. Each folder represents each plugin in the same name." => "ordner. Jeder Ordner steht für jedes Plugin mit demselben Namen.",
...
"Directory Source" => "Verzeichnis Quelle",
...
"Search for plugin..." => "Suchen Sie nach einer Erweiterung...",
...
"Multi" => "Multi",
"Others" => "Andere",
"Directory Last Updated" => "Verzeichnis zuletzt aktualisiert",
...
"Updated plugin version available" => "Aktualisierte Plugin-Version verfügbar",
"Unable to detect the last time this plugin was updated or a version was released" => "Es konnte nicht festgestellt werden, wann dieses Plugin das letzte Mal aktualisiert wurde oder eine neue Version veröffentlicht wurde",
"Not Specified" => "Nicht spezifiziert",
"View Readme" => "README anzeigen",
"This plugin contains no database changes" => "Dieses Plugin enthält keine Änderungen an der Datenbank",
"This plugin has not specified any database changes" => "Dieses Plugin hat keine Datenbankänderungen angegeben",
"This plugin overrides certain templates or models" => "Dieses Plugin setzt bestimmte Vorlagen oder Modelle außer Kraft",
"This plugin does not override any templates or models" => "Dieses Plugin setzt keine Vorlagen oder Modelle außer Kraft",
"This plugin has not specified any template or model overrides" => "Dieses Plugin hat keine Vorlagen- oder Modellüberschreibungen angegeben",
"This plugin contains hooks" => "Dieses Plugin enthält Hooks",
"This plugin does not contain any hooks" => "Dieses Plugin enthält keine Hooks",
"This plugin has not specified any hooks" => "Dieses Plugin hat keine Hooks angegeben",
"Install" => "Installieren Sie",
"Install this plugin" => "Installieren Sie dieses Plugin",
"Update" => "Update",
"Update this plugin" => "Dieses Plugin aktualisieren",
...
"Top" => "Top",
"Install Manual Plugin" => "Manuelles Plugin installieren",
...
"From URL" => "Von URL",
"Warning" => "Warnung",
"Use these plugins with great caution and check their functionality with the plugin developer before installing" => "Verwenden Sie diese Erweiterung mit großer Vorsicht und überprüfen Sie ihre Funktionalität mit dem Plugin-Entwickler, bevor Sie sie installieren",
...
"Name" => "Name",
"Author" => "Autor",
"Kanboard Compatibility" => "Kanboard Kompatibilität",
...
"Search for installed plugin..." => "Suche nach installierten Erweiterungen...",
"Search installed plugins" => "Installierte Erweiterungen suchen",
"You have %s plugins installed" => "Sie haben %s Erweiterungen installiert",
"and %s incompatible plugin(s)" => "und %s inkompatible Plugin(s)",
"Technical Info" => "Technische Informationen",
"Content Cleaner" => "Inhalt Reiniger"
