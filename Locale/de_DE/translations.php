...
return array(
    ...
    // GENERAL
    //
    'Replace the Installed Plugins section with a whole new interface. Plugin Manager provides both users and developers with an improved comprehensive layout displaying a new section for troubleshooting plugins with a new plugin structure breakdown for each plugin. Install plugins direct from the Plugin Directory or explore new upcoming or untested features from manual plugins.' => 'Ersetzen Sie den Abschnitt Installierte Plugins durch eine völlig neue Oberfläche. Der Plugin Manager bietet sowohl Benutzern als auch Entwicklern ein verbessertes, umfassendes Layout mit einem neuen Abschnitt für die Fehlersuche bei Plugins und einer neuen Aufschlüsselung der Plugin Struktur für jedes Plugin. Installieren Sie Plugins direkt aus dem Plugin Verzeichnis oder erforschen Sie neue oder noch nicht getestete Funktionen von manuellen Plugins.',
    'Plugins' => 'Plugins',
